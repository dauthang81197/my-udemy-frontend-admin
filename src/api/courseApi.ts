...
export const courseApi = {
  ...
  getById: (id: string) =>
    axiosInstance.get<ApiResponse<Course>>(`${BASE}:id`, { params: { id } }),

  create: (data: CreateCourseRequest) =>
    axiosInstance.post<ApiResponse<Course>>(BASE, data),

  update: (id: string, data: UpdateCourseRequest) =>
    axiosInstance.put<ApiResponse<Course>>(`${BASE}:id`, data, { params: { id } }),

  delete: (id: string) =>
    axiosInstance.delete<ApiResponse<Course>>(`${BASE}:id`, { params: { id } }),
};
